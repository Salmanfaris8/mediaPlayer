...
const Add = ({setVideoUploadResponse}) => {
  ...
  return (
    ...
    <div className='d-flex justify-content-between align-items-center'>
      ...
      <Button className='btn btn-danger rounded-circle ps-3 pe-3 fs-5 fw-bolder ms-2' onClick={handleShow}>+</Button>
    </div>
    <Modal
      show={show}
      onHide={handleClose}
      ...
      <Modal.Footer>
        ...
        <Button onClick={handleUploadVideo} className='btn btn-dark'>Upload</Button>
      </Modal.Footer>
    </Modal>
  </>
  )
