    ...
    <div style={{height:'300px'}} className='container mt-5 w-100'>
      <div className="d-flex justify-content-between">
        ...
        <div className="d-flex flex-column">
          ...
          <Link to={'/history'} style={{textDecoration:'none',color:'black'}}>Watch History Page</Link>
        </div>
        <div className="d-flex flex-column">
        <h5>Guides</h5>
      ...
      <p className='text-center mt-3'>Copyright &copy; June 2024 Batch, Media Plyer.Built with React</p>
    </div>
  )
}
